...
async def notification2(message: types.Message):
    ...
    if msg == "уведомления":
        await message.answer('Меню уведомлений ', reply_markup=button.notification_button)
        ...
        await message.reply(
            "Уведомления отправляют расписание на следующий день каждый вечер в 19:00, если они включены. Вы можете включить или выключить уведомления в меню уведомлений.",
